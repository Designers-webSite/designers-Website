        ...
        <div className='content sections'>
            ...
            <div className="section">
                <div className="header">
                     <div className=''><h2 className="main-title"> services</h2></div>
     ...
     <button onClick={()=>{navigate(`/searchUtilityByTitle/${search}`)}}>Search</button>
                ...
                <div className="items">
                    {allutility.map(ele=>(
                        ...
                        {/* <Link to={`/providerServies/${ele.user.id}`} className="user"><img src={ele.user.picture} alt="" /></Link>  */}
                        {console.log(ele.user.picture) }                         <div className="head">
                                {/* Put image src here */}
